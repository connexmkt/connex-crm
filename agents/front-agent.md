...
### Purpose
Connex CRM is a front-end-only CRM for marketing agencies. It manages clients, leads, campaigns, content, and reports. All data currently comes from `lib/seed-data.ts` (static mock data — there is no backend yet).
